 ...
 *     ITEM.C:1860, 18 src lines, frame 32 bytes, saved-reg mask 0x80070000
 *
 ...
 * `it->proc = ProcItemGosin` assignment. See ReqItemKusuri.c's header for the
...
int ReqItemGosin(PARAM_ITEM_USE *p)
{
    tag_TItem *it;
    VECTOR *st;
    Humanoid *us;
