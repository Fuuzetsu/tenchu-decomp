...
struct NodeIndexType
{
    s16 y;      /* 0x00 */
    s16 n;      /* 0x02 */
    long index; /* 0x04: relative offset on disk, absolute address after load */
    s16 x1;     /* 0x08 */
    s16 z1;     /* 0x0A */
    s16 x2;     /* 0x0C */
    s16 z2;     /* 0x0E */
...
{
    long index;                  /* 0x00: node-list address after relocation */
...
/* ConflictObjectType.common is PSX.SYM's original untyped owner pointer.
 * Ownerless item and door collisions store the small sentinels below. */
...
enum cva_format_constant
{
    ...
    CVA_ACTOR_SUSPEND_HEIGHT_DELTA = 20000,
