...
//
// undefined4
// FUN_80058c70(int param_1,int param_2,undefined4 param_3,int param_4,undefined4 param_5,int param_6,
//             undefined4 *param_7)
//
// {
//   int iVar1;
...
//     local_38 = puVar5;
//     do {
//       *(undefined2 *)(param_7 + 0x20) = *(undefined2 *)((uint)(ushort)puVar4[0xd] * 8 + param_2);
//       *(undefined2 *)((int)param_7 + 0x82) =
//            *(undefined2 *)((uint)(ushort)puVar4[0xd] * 8 + param_2 + 2);
//       *(undefined2 *)(param_7 + 0x21) = *(undefined2 *)((uint)(ushort)puVar4[0xd] * 8 + param_2 + 4)
//       ;
//       *(undefined2 *)(param_7 + 0x26) = *(undefined2 *)((uint)(ushort)puVar4[0xe] * 8 + param_2);
//       *(undefined2 *)((int)param_7 + 0x9a) =
//            *(undefined2 *)((uint)(ushort)puVar4[0xe] * 8 + param_2 + 2);
//       *(undefined2 *)(param_7 + 0x27) = *(undefined2 *)((uint)(ushort)puVar4[0xe] * 8 + param_2 + 4)
//       ;
//       *(undefined2 *)(param_7 + 0x2c) = *(undefined2 *)((uint)(ushort)puVar4[0xf] * 8 + param_2);
//       *(undefined2 *)((int)param_7 + 0xb2) =
//            *(undefined2 *)((uint)(ushort)puVar4[0xf] * 8 + param_2 + 2);
//       *(undefined2 *)(param_7 + 0x2d) = *(undefined2 *)((uint)(ushort)puVar4[0xf] * 8 + param_2 + 4)
//       ;
//       *(undefined2 *)(param_7 + 0x32) = *(undefined2 *)((uint)(ushort)puVar4[0x10] * 8 + param_2);
//       *(undefined2 *)((int)param_7 + 0xca) =
//            *(undefined2 *)((uint)(ushort)puVar4[0x10] * 8 + param_2 + 2);
//       *(undefined2 *)(param_7 + 0x33) =
//            *(undefined2 *)((uint)(ushort)puVar4[0x10] * 8 + param_2 + 4);
//       *puVar5 = r0;
//       puVar5[1] = r1;
//       puVar5[2] = r2;
//       puVar5[3] = r0_00;
...
//         param_7[0x28] = *(undefined4 *)(puVar4 + 7);
//         *(undefined1 *)((int)param_7 + 0xa3) = uVar6;
//         param_7[0x2e] = *(undefined4 *)(puVar4 + 9);
//         *(undefined1 *)((int)param_7 + 0xbb) = uVar6;
//         param_7[0x34] = *(undefined4 *)(puVar4 + 0xb);
