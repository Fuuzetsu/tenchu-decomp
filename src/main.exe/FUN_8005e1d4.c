...
INCLUDE_ASM("config/../.shake/gen/main.exe/asm/nonmatchings/FUN_8005e1d4", FUN_8005e1d4);

// triage: VERY-HARD — 87 insns, 3 GTE CMD — UN-SPLITTABLE (as can't assemble), 1 loop, 0 callees
...
//         if (((0 < iVar3) && (iVar3 = (int)in_t0 - in_t9, 0 < (int)in_t0 - in_t8)) &&
//            (in_t0 = (u_long *)((int)in_t0 * 4), iVar3 < 0)) {
//           gte_ldRGB0(in_t5 + 4);
//           gte_ldRGB1(in_t5 + 8);
