 ...
 *                  ATTR_SEARCH | phase with chase set to the
 *                  last-known spot)
 ...
 *   ATTR_WEAPON_DRAWN 0x0040 — combat-ready / weapon drawn: EquipWeapon
 ...
 *                  with it (or PHASE_ALERT) the kill scores Murders
...
#define ANGLE_SIXTEENTH (ANGLE_FULL / 16)
#define ANGLE_SIXTEENTH_MASK \
