 ...
 * TMD_FAST_WORK *) signature). The ONLY difference from fast_tng4_ is the
...
u_long *fast_tnf4_(u_short *primitive, u_long vertop, u_long *packet, int count, TMD_FAST_WORK *wp)
{
    TMD_FAST_WORK *work;
    POLY_GT4 *prim;
    u_long *flagAddr;
