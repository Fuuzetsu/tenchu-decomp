 ...
 * is_humanoid_on_stage_.c/GetDirection.c/MoveHumanoid.c
 * (address-contiguous; is_humanoid_on_stage_ sits immediately
 ...
 *    is_humanoid_on_stage_'s `s32 i` (which strength-reduces
