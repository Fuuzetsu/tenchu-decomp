...
enum
{
    GPU_POLY_F3_WORDS = GPU_PACKET_WORDS(POLY_F3),
    GPU_POLY_GT3_WORDS = GPU_PACKET_WORDS(POLY_GT3),
    GPU_POLY_GT4_WORDS = GPU_PACKET_WORDS(POLY_GT4),
    GPU_POLY_F3_LENGTH = GPU_PACKET_LENGTH(POLY_F3),
    GPU_POLY_GT3_LENGTH = GPU_PACKET_LENGTH(POLY_GT3),
    GPU_POLY_GT4_LENGTH = GPU_PACKET_LENGTH(POLY_GT4),
