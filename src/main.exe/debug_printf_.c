...
/*
 * debug_printf_ (0x8005fe38, 0x50 bytes) — appends a printf-style formatted
 * message to the shared debug-message ring buffer that debug_msg_open_ seeds
 ...
 * end of the very same AdtMsgBuf[0x1000] buffer debug_msg_open_ writes into —
