...
/*
 * FUN_8005a3cc (0x8005a3cc, 0x3d8 bytes) — DecodeTMD-family primitive
 * renderer, the 1.00 mnemonic clone of FUN_80059ff4 (TMD primitive code
 * 0x25's gradation sibling in FUN_800593a0's switch; all four family
 * members share the (u_short *, u_long, u_long *, u_short, u_long *)
 * signature). The ONLY differences from FUN_80059ff4 are the record
 ...
 * FUN_80059ff4.c verbatim; read that file's header for the full
 * mechanism account.
...
u_long *FUN_8005a3cc(u_short *primitive, u_long vertop, u_long *packet, int count, TMD_FAST_WORK *wp)
{
    TMD_FAST_WORK *work;
    POLY_GT3 *prim;
    u_char *codeAddr;
