...
maspsxGpExterns src = extra (takeBaseName src) <> concat [["--gp-extern", s] | s <- syms (takeBaseName src)]
  where
    ...
    syms "THINK" = ["StrainRatio", "Me", "Pad", "Attrib", "PlayerSSR", "ActionHalt", "EmergencyNotice", "SR", "Distance", "ProbeLevelLow", "ProbeAttrib", "ProbeLevelHigh", "EngageLevel", "Degree", "AttackActionCount", "DeathIndex"]
