...
maspsxGpExterns src = extra (takeBaseName src) <> concat [["--gp-extern", s] | s <- syms (takeBaseName src)]
  where
    ...
    syms "SetSmoke" = ["EFFECT_CURSOR_"]
    syms "SetBleeds" = ["EFFECT_CURSOR_"]
    syms "EndDrawing" = ["GameClock", "SkipFrame", "DrawingPage", "PacketUsed", "OTablePt", "time"]
    syms "SetBlood" = ["EFFECT_CURSOR_"]
    syms "SetHinoko" = ["EFFECT_CURSOR_"]
    ...
    syms "SetExplosion" = ["EFFECT_CURSOR_"]
    ...
    syms "SetFrame" = ["EFFECT_CURSOR_"]
    syms "SetSplash" = ["EFFECT_CURSOR_"]
    syms "SetBleed" = ["EFFECT_CURSOR_"]
    ...
    syms "set_fade_" = ["EFFECT_CURSOR_"]
    syms "set_impact_ex_" = ["EFFECT_CURSOR_"]
    ...
    syms "ReqItemGun" = ["ic"]
    syms "SetSmokeS" = ["EFFECT_CURSOR_"]
    syms "SetupAppearance" = ["NowStage", "ARMOUR_EQUIPPED_", "sstage", "smode"]
    ...
    syms "DrawShadow" = ["EFFECT_CURSOR_", "ShadowMdl"]
    syms "register_character_death" = ["DeathIndex", "EmergencyNotice"]
    syms "Think3attack" = ["Me_THINK_C", "SR", "Distance", "Degree", "EngageLevel"]
    syms "SetFlyWire" = ["EFFECT_CURSOR_"]
    syms "SetGore" = ["EFFECT_CURSOR_"]
    syms "InitEffect" = ["ShadowMdl", "BLOOD_POOL_MODEL_", "AfterIMG", "ModelHook", "TexScrollX", "TexScrollY"]
    syms "spawn_smoke_burst_" = ["EFFECT_CURSOR_"]
    ...
    syms "swap_balma_area_map_" = ["BalmaAreaMap", "GlobalAreaMap", "FieldIndex", "FieldArea"]
