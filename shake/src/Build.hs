...
maspsxGpExterns src = extra (takeBaseName src) <> concat [["--gp-extern", s] | s <- syms (takeBaseName src)]
  where
    ...
    syms "PlayVoice" = ["VoiceXaName", "VoiceXaNameF", "VoiceXaNameI", "VoiceXaNameJ", "D_80097C9C", "D_80097C98"]
    ...
    syms "PlaySE" = ["voice"]
    syms "SetupTexScroll" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_", "D_80097F30", "D_80097F32"]
    syms "AVCameraSetup" = ["CVAnow", "CameraTarget"]
    syms "AVCameraControl" = ["CameraPanMode", "CameraSpeed", "CameraTarget"]
    syms "CVAsequence" = ["CVAdata", "CVAnow", "CameraTarget", "D_80097CCC", "CVAtime"]
    syms "CVAupdate" = ["CVAnow", "D_80097CCC", "CameraTarget", "CameraPanMode", "CameraSpeed", "CVAdata"]
