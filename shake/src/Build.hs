...
maspsxGpExterns src = extra (takeBaseName src) <> concat [["--gp-extern", s] | s <- syms (takeBaseName src)]
  where
    ...
    extra "spawn_damage_effect_" = ["--expand-div"]
    extra "draw_sprite_coord_" = ["--expand-div"]
    extra "draw_sprite_pair_" = ["--expand-div"]
    ...
    extra "trace_ground_" = ["--expand-div"]
    extra "proc_misc_sound_" = ["--expand-div"]
    extra "proc_misc_puff_" = ["--expand-div"]
    ...
    extra "camera_terrain_pitch_" = ["--expand-div"]
    extra "ArrangeLocalMatrix" = ["--expand-div"]
    extra "spawn_smoke_burst_" = ["--expand-div"]
    ...
    syms "PlayVoice" = ["VoiceXaName", "VoiceXaNameF", "VoiceXaNameI", "VoiceXaNameJ", "VoiceFiles2", "VoiceFiles1"]
    ...
    syms "EndDrawing" = ["GameClock", "SkipFrame", "DrawingPage", "PacketUsed", "OTablePt", "time"]
    ...
    syms "spawn_damage_effect_" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_"]
    syms "ChasetoTarget" = ["Me_THINK_C", "Attrib", "Distance"]
    syms "GetAreaMapPassage" = ["FieldArea", "FieldIndex"]
    syms "PlaySE" = ["voice"]
    syms "SetupTexScroll" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_", "TexScrollX", "TexScrollY"]
    ...
    syms "ReqItemJirai" = ["ic"]
    syms "ReqItemDokudango" = ["ic"]
    syms "ReqItemSmoke" = ["ic"]
    syms "ReqItemFire" = ["ic"]
    syms "ReqItemShinsoku" = ["ic"]
    syms "ReqItemNinken" = ["ic"]
    syms "ReqItemKaengeki" = ["ic"]
    syms "ReqItemGoshikimai" = ["ic"]
    syms "ReqItemNemuri" = ["ic"]
    syms "ReqItemKusuri" = ["ic"]
    syms "ReqItemKawarimi" = ["ic"]
    syms "ReqItemGosin" = ["ic"]
    syms "ReqItemHenshin" = ["ic"]
    syms "ReqItemManebue" = ["ic"]
    syms "ReqItemMakibishi" = ["ic"]
    syms "ReqItemLightningBolt" = ["ic"]
    syms "ReqItemNingyo" = ["ic"]
    syms "ReqItemUse" = ["ic", "SyurikenModel", "sprNapalm"]
    syms "ReqItemLaunch" = ["ic", "SyurikenModel"]
    ...
    syms "handle_balmer_acm_" = ["GlobalAreaMap", "FieldIndex", "BalmaAreaMap", "FieldArea"]
    ...
    syms "InitFileSystem" = ["ReadMode", "TotalIO", "MDfat"]
    syms "cbAccess" = ["AccessPower"]
    syms "debug_printf_" = ["AdtMsgPtr"]
    syms "check_card_file_" = ["TENCHU_ID"]
    syms "set_fade_" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_"]
    syms "set_impact_ex_" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_"]
    syms "InitMisc" = ["Misc_fInitial"]
    syms "InitializeItem" = ["SyurikenModel", "ArrowModel", "NingyoModel", "HappouModel", "sprNapalm", "sprNapalm2", "Item_fInitial"]
    syms "ProcItemNapalm" = ["sprNapalm2"]
    syms "DoMiscProc" = ["Misc_fInitial"]
    syms "LoadSI" = ["CID"]
    syms "SaveSI" = ["CID"]
    ...
    syms "StateTransition" = ["StrainRatio", "Me_THINK_C", "Pad", "Attrib", "PlayerSSR", "ActionHalt", "EmergencyNotice", "SR", "Distance", "ProbeLevelLow", "ProbeAttrib", "ProbeLevelHigh", "EngageLevel", "Degree"]
    ...
    syms "DamageControl" = ["Me_MOTION_C", "MotionUpdateMode", "motID", "dtL", "motMODE", "dtM", "dtR", "DeadHumanoid", "dtV"]
    syms "ProcItemNinken" = ["NINKEN_CHARACTER_PTR"]
    syms "ActKAGI" = ["dtM", "Me_MOTION_C", "dtL", "motMODE", "motID", "dtR", "MotionUpdateMode", "dtV"]
    syms "DrawGore" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_"]
    syms "ProcItemHenshin" = ["HenshinItem", "HenshinCount"]
    ...
    syms "draw_card_help_" = ["McardPageNow", "McardHelp", "McardAnswered", "McardPageText", "McardSprite", "CardStateFlag"]
    ...
    syms "register_character_death" = ["DeathIndex", "EmergencyNotice"]
    ...
    syms "InitEffect" = ["ShadowMdl", "LOCAL_COORDINATES_", "AfterIMG", "ModelHook", "TexScrollX", "TexScrollY"]
    syms "spawn_smoke_burst_" = ["CURRENT_OFFSET_INTO_SOME_SELF_CALL_STRUCT_AREA_"]
    syms "AttackControl" = ["Me_MOTION_C", "dtL", "dtR", "motID", "motMODE", "dtPAD", "dtM"]
    syms "Think1target" = ["Me_THINK_C", "SR", "Attrib", "EmergencyNotice"]
    syms "setup_card_screen_" = ["McardVramSave", "McardHelp", "McardSprite"]
    syms "ActDEAD" = ["Me_MOTION_C", "dtM", "dtV", "motID", "dtL", "motMODE", "DeadHumanoid"]
    syms "ActSTICKON" = ["dtM", "Me_MOTION_C", "dtR", "dtCMD", "motID", "motMODE", "MotionUpdateMode", "dtPAD", "dtV", "StickonItem", "dtL"]
    ...
    syms "update_card_screen_" = ["McardState", "McardPage", "McardFile", "McardRetry", "CardStateFlag"]
    syms "update_card_message_" = ["CardRetryCount", "CardStateFlag"]
    syms "FallCheck" = ["motID", "Me_MOTION_C", "dtM", "dtL", "motMODE", "MotionUpdateMode"]
    syms "ItemControl" = ["Me_MOTION_C", "motID", "motMODE"]
    syms "character_balma_around_main_routine_" = ["BalmaAreaMap", "GlobalAreaMap", "FieldIndex", "FieldArea"]
    ...
    syms "spread_blood_pool_" = ["LOCAL_COORDINATES_"]
