...
maspsxGpExterns src = extra (takeBaseName src) <> concat [["--gp-extern", s] | s <- syms (takeBaseName src)]
  where
    ...
    syms "FUN_8001b2f4" = ["ControlScheme"]
    ...
    syms "FUN_8005b17c" = ["McardPageNow", "McardHelp", "McardAnswered", "McardPageText", "McardSprite", "CardStateFlag"]
    ...
    syms "FUN_8005adbc" = ["McardVramSave", "McardHelp", "McardSprite"]
    ...
    syms "FUN_8005a7a4" = ["McardState", "McardPage", "McardFile", "McardRetry", "CardStateFlag"]
