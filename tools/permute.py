...
GP_EXTERNS = {
    ...
    "THINK": ["StrainRatio", "Me", "Pad", "Attrib", "PlayerSSR", "ActionHalt", "EmergencyNotice", "SR", "Distance", "ProbeLevelLow", "ProbeAttrib", "ProbeLevelHigh", "EngageLevel", "Degree", "AttackActionCount", "DeathIndex"],
