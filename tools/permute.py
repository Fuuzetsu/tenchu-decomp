...
GP_EXTERNS = {
    ...
    "3DCTRL": ["GameClock", "SkipFrame", "DrawingPage", "PacketUsed", "OTablePt", "time"],
    "FILEIO": ["AccessPower", "ReadMode", "TotalIO", "MemoryLoadAddress", "MDfat"],
    "VALLOC": ["virtual_memory_pool"],
    "CONFLICT": ["GlobalAreaMap", "FieldIndex", "FieldArea", "AreaMapLastY", "FieldAttrib", "ConflictModel", "ConflictObjects", "ConflictDistance"],
    "ACTION": ["CommonMotion", "PlayerMotion", "StageMotion", "SplineFracOld", "SplineFrac", "SplineRow", "MotionPack"],
    ...
    "HUMAN": ["Humans", "VISIBLE_ENEMIES_"],
    "EFFECT": ["EFFECT_CURSOR_", "ModelHook", "TexScrollX", "TexScrollY", "ShadowMdl", "BLOOD_POOL_MODEL_", "AfterIMG"],
    "MOTION": ["Me_MOTION_C", "dtCMD", "dtPAD", "dtL", "dtR", "dtV", "dtM", "motID", "motMODE", "MotionUpdateMode", "DeadHumanoid", "StickonItem"],
    "INFOVIEW": ["ItemCursor", "MapSlideX", "MapSlideY", "PutMapMode", "SelectedItem", "StrainPhase", "fInitialize"],
    "ITEM": ["fInitial", "ic", "SyurikenModel", "ArrowModel", "NingyoModel", "HappouModel", "sprNapalm", "sprNapalm2", "NINKEN_CHARACTER_PTR", "NingyoCount", "HenshinItem", "HenshinCount"],
    ...
    "SetBlood": ["EFFECT_CURSOR_"],
    "SetHinoko": ["EFFECT_CURSOR_"],
    "SetSmoke": ["EFFECT_CURSOR_"],
    "SetBleeds": ["EFFECT_CURSOR_"],
    "JumpControl": ["dtL", "dtM", "motID", "Me_MOTION_C", "motMODE", "dtV", "dtPAD"],
    "HangCheck": ["Me_MOTION_C", "motID", "dtL", "dtR", "MotionUpdateMode", "motMODE"],
    "SEMNG": ["StageSE", "VoiceMode"],
    ...
    "STAGE": ["StageEvent", "StageTime", "FriendHits", "Murders", "Findenemies", "Criticals", "Event", "StagePlayer", "StageCitizens", "StageEnemies", "StageBosses"],
    ...
    "Think1sleep": ["Me_THINK_C", "SR", "Attrib", "EmergencyNotice"],
    "ReqItemDrop": ["ic"],
    "GetFreeItemSlot": ["ic"],
    ...
    "ReqItemManebue": ["ic"],
    "ReqItemMakibishi": ["ic"],
    "ReqItemLightningBolt": ["ic"],
    "ReqItemNingyo": ["ic"],
    "ReqItemUse": ["ic", "SyurikenModel", "sprNapalm"],
    "ReqItemLaunch": ["ic", "SyurikenModel"],
    "ReqItemArrow": ["ic", "ArrowModel"],
    "ReqItemHappou": ["ic"],
    ...
    "MEMCARD": ["TENCHU_ID"],
    "SetupAfterimage": ["AfterIMG"],
    "MotionAndMove": ["MotionUpdateMode", "Me_MOTION_C", "motID", "motMODE"],
    "SetFrame": ["EFFECT_CURSOR_"],
    "SetSplash": ["EFFECT_CURSOR_"],
    "SetBleed": ["EFFECT_CURSOR_"],
    ...
    "DamageControl": ["Me_MOTION_C", "MotionUpdateMode", "motID", "dtL", "motMODE", "dtM", "dtR", "DeadHumanoid", "dtV"],
    "ProcItemNinken": ["NINKEN_CHARACTER_PTR"],
    "ActKAGI": ["dtM", "Me_MOTION_C", "dtL", "motMODE", "motID", "dtR", "MotionUpdateMode", "dtV"],
    "DrawGore": ["EFFECT_CURSOR_"],
    "ProcItemHenshin": ["HenshinItem", "HenshinCount"],
    ...
    "ActivateHumans": ["ThinkBudgetRaw", "ThinkBudget", "ThinkCount", "StageID"],
    "ProcItemNingyo": ["NingyoCount", "NingyoModel"],
    "AddEnemy": ["CurrentEnemyID"],
    "draw_card_help_": ["McardPageNow", "McardHelp", "McardAnswered", "McardPageText", "McardSprite", "McardStateFlag"],
    "LoadConstruction": ["mma", "ObjectArc", "StageID"],
    "CreateStage": ["StageID"],
    "SetWire": ["ModelHook"],
    "think_alarm_reaction_": ["Me_THINK_C", "Attrib", "EmergencyNotice", "Degree", "Distance"],
    ...
    "DrawShadow": ["EFFECT_CURSOR_", "ShadowMdl"],
    "register_character_death": ["DeathIndex", "EmergencyNotice"],
    "Think3attack": ["Me_THINK_C", "SR", "Distance", "Degree", "EngageLevel"],
    "SetFlyWire": ["EFFECT_CURSOR_"],
    "SetGore": ["EFFECT_CURSOR_"],
    "InitEffect": ["ShadowMdl", "BLOOD_POOL_MODEL_", "AfterIMG", "ModelHook", "TexScrollX", "TexScrollY"],
    "spawn_smoke_burst_": ["EFFECT_CURSOR_"],
    ...
    "update_card_screen_": ["McardState", "McardPage", "McardFile", "McardRetry", "McardStateFlag"],
    "update_card_message_": ["McardRetryCount", "McardStateFlag"],
    "FallCheck": ["motID", "Me_MOTION_C", "dtM", "dtL", "motMODE", "MotionUpdateMode"],
    "ItemControl": ["Me_MOTION_C", "motID", "motMODE"],
    "swap_balma_area_map_": ["BalmaAreaMap", "GlobalAreaMap", "FieldIndex", "FieldArea"],
...
MASPSX_EXTRA = {
    ...
    "think_alarm_reaction_": ["--expand-div"],
