...
CATEGORY_RULES = {
    "regalloc": [
        "type-width", "cmp-polarity", "loop-fence", "paired-loop-fence", "loop-range", "split-chain",
    ...
    "cse/coalescing": [
        "type-width", "loop-fence", "paired-loop-fence", "loop-range", "temp-inline",
        "vector-copy-adjust", "subscript-postinc", "switch-cse-evict",
        "pointee-volatile",
    ],
    "jump/cross-jump": ["case-fence", "and-nest", "if-else-invert"],
    "schedule/delay": [
        "type-width", "loop-fence", "paired-loop-fence", "loop-range", "cmp-swap", "cmp-polarity",
